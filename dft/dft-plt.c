/* DFT-PLT.C - Procedures used to plot data regarding diffusion trees. */
...
extern void dft_initialize (log_gobbled *);
extern void dft_available  (quantities_described, log_gobbled *);
extern void dft_evaluate   (quantities_described, quantities_held *,
                            log_gobbled *);
extern void dft_mc_cleanup (void);
