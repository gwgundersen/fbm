/* SRC-DATA.H - Interface for reading data for source model. */
...
void src_data_read(int, int);
void src_data_free(void);

double *src_data_read_inputs  (numin_source *, int *);
double *src_data_read_targets (numin_source *, int);
